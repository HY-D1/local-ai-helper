...
class AgentController:
    ...
    def __init__(self):
        ...
        self.agents: Dict[Tuple[str, Optional[str]], BaseAgent] = {}
    ...
    def _get_agent(self, agent_mode: str, model: Optional[str] = None) -> BaseAgent:
        ...
        Returns:
            Agent instance
        """
        key = (agent_mode, model)
        if key in self.agents:
            return self.agents[key]

        # For general mode, use BaseAgent directly
        if agent_mode == "general":
            agent = BaseAgent(agent_mode=agent_mode, model=model)
        ...
        agent = agent_class(agent_mode=agent_mode, model=model)
        self.agents[key] = agent
        return agent
